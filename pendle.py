...
def open_long(symbol,order_usdt):
    ...
    while logo_b == 0:
        try:
            ...
            print('开多====' + str(buy_res_base['data']))
...
def close_order(symbol,order_num,volumePlace):
    ...
    while logo_b == 0:
        try:
            ...
            print('平多====' + str(sell_res_base['data']))
...
print('btc数量和价格精度：'+str(btc_volumePlace))
...
while True:
    ...
    if len(raw_data_btc) == 0:
        ...
        print('初始化btc,网格总数：'+str(len(raw_data_btc)))
    else:
        if js%30==0:
            print('对既有的btc网格进行监控')
    # 订单监控
    ...
    if js%30==0:
        print('初始化btc,网格总数：'+str(len(sub_raw_data_btc)))
    ...
    btc_price = get_price(symbol)
    if js%30==0:
        print('btc各网格价格'+str('--')+str(btc_up_one_price)+str('--')+str(btc_base_price)+str('--')+str(btc_down_one_price)+str('--')+str(btc_down_two_price)+str('--')+str(btc_down_three_price)+str('--')+str(btc_down_four_price)+str('--')+str(btc_down_five_price)+str('--')+str(btc_down_six_price)\
                +str('--')+str(btc_down_seven_price)+str('--')+str(btc_down_eight_price)+str('--')+str(btc_down_nine_price))
        print('btc各网格数量'+str('--')+str(btc_base_num)+str('--')+str(btc_down_one_num)+str('--')+str(btc_down_two_num)+str('--')+str(btc_down_three_num)+str('--')+str(btc_down_four_num)+str('--')+str(btc_down_five_num)+str('--')+str(btc_down_six_num)\
                +str('--')+str(btc_down_seven_num)+str('--')+str(btc_down_eight_num)+str('--')+str(btc_down_nine_num))
        print('btc当前价格'+str(btc_price))
